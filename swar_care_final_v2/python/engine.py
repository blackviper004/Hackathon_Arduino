...
class SwarCareEngine:
    ...
    def __init__(self):
        ...
        # Piezo hardware sample rate — used for recording and display.
        # (The vibration K-means anomaly model has been removed; piezo data
        # is still recorded to CSV for reference but not AI-scored.)
        ...
        # analyze_veena_ai() can score a bounded, recent window instead
